...
select * from cn_note_activity;
 ...
 select * from cn_share where cn_share_title like ‘%我爱%’ or cn_share_body like ‘%我爱%’ 
select * from cn_share 
select * from cn_note where cn_notebook_id='85726509-f358-4a21-bb88-6af1c42cf44b'
select * from cn_notebook where cn_notebook_name='123'

INSERT INTO `cn_note` VALUES ('4', 'bcc88fb4-b14b-4287-abd9-d75e7cdaf945', '55eb1254-4e56-4179-ade5-4abd9cada5cd', null, null, 'javaketangbiji1', 'abaqrwtbababa', '1402916621416', '1402916621416');
commit;
select * from cn_note where cn_notebook_id='bcc88fb4-b14b-4287-abd9-d75e7cdaf945' and cn_user_id='55eb1254-4e56-4179-ade5-4abd9cada5cd'
select  distinct cn_user_id from cn_notebook
select *from cn_notebook  where cn_user_id='55eb1254-4e56-4179-ade5-4abd9cada5cd'
...
-- ----------------------------
INSERT INTO `cn_notebook` VALUES ('0037215c-09fe-4eaa-aeb5-25a340c6b39e', '55eb1254-4e56-4179-ade5-4abd9cada5cd', '5', 'web', null, '2014-06-27 15:18:59');
commit
